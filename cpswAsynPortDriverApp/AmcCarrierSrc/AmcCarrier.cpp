...
#define JESDRX_BASE_ADDR_C   ( (0x80000000 + 0x00000000)  )
#define JESDTX_BASE_ADDR_C   ( (0x80000000 + 0x00100000)  )
#define LMK04828_BASE_ADDR_C   ( (0x80000000 + 0x00200000)  )
#define ADC16DX370_0_BASE_ADDR_C   ( (0x80000000 + 0x00300000) )
#define ADC16DX370_1_BASE_ADDR_C   ( (0x80000000 + 0x00400000)  )
#define DAC38J84_BASE_ADDR_C   ( (0x80000000 + 0x00500000) )
#define AMCGENERICADCDACCTRL_BASE_ADDR_C   ( (0x80000000 + 0x00600000) )
